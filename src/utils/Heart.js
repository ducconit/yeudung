...
function HeartBase(width, height) {
  ...
  const palette = [
    new THREE.Color('#B12763'),
    new THREE.Color('#B31942'),
    new THREE.Color('#A30B2E'),
  ...
  class SparkPoint {
    ...
    update(a) {
      const noise = noise4D(this.pos.x * 1, this.pos.y * 1, this.pos.z * 1, 0.1) + 1.5;
      const noise2 = noise4D(this.pos.x * 500, this.pos.y * 500, this.pos.z * 500, 1) + 1;
